...
~~~
INSERT INTO DISTRICT(ID,NAME,ID_COUNTRY) VALUES(1,'Guatemala','1');
INSERT INTO DISTRICT(ID,NAME,ID_COUNTRY) VALUES(2,'Jalapa','1');
INSERT INTO DISTRICT(ID,NAME,ID_COUNTRY) VALUES(3,'El Progreso','1');
INSERT INTO DISTRICT(ID,NAME,ID_COUNTRY) VALUES(4,'Sonsonate','2');
INSERT INTO DISTRICT(ID,NAME,ID_COUNTRY) VALUES(5,'Santa Ana','2');
INSERT INTO DISTRICT(ID,NAME,ID_COUNTRY) VALUES(6,'San Salvador','2');
INSERT INTO DISTRICT(ID,NAME,ID_COUNTRY) VALUES(7,'Olancho','3');
INSERT INTO DISTRICT(ID,NAME,ID_COUNTRY) VALUES(8,'Tegucigalpa','3');
INSERT INTO DISTRICT(ID,NAME,ID_COUNTRY) VALUES(9,'San Pedro Sula','3');
~~~
Ingreso de ciudades
~~~
...
SELECT 
  ...
  FROM CITY C
  INNER JOIN DISTRICT D ON C.ID_DISTRICT=D.ID
  INNER JOIN COUNTRY P ON D.ID_COUNTRY = P.ID
  WHERE P.COUNTRYCODE='GTM'
  
  ~~~
  
  SELECT NAME,LENGTH(NAME),SUBSTRING(NAME,5) as primera_letra FROM CITY
  WHERE LENGTH(NAME)>10
  
  
  #agrupamientos aggregate function
  ~~~
  SELECT 
  P.NAME,COUNT(1) AS CANTIDAD_DISTRITOS
  FROM CITY C
  INNER JOIN DISTRICT D ON C.ID_DISTRICT=D.ID
  INNER JOIN COUNTRY P ON D.ID_COUNTRY = P.ID
  GROUP BY P.ID
  ORDER BY CANTIDAD_POBLACION_PAIS DESC
  ~~~